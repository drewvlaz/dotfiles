...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #{?window_zoomed_flag,#[fg=$onedark_yellow#,bg=$onedark_visual_grey#,nobold#,nounderscore#,noitalics],#[fg=$onedark_green#,bg=$onedark_visual_grey#,nobold#,nounderscore#,noitalics]}#{?window_zoomed_flag,#[fg=$onedark_black#,bg=$onedark_yellow#,bold],#[fg=$onedark_black#,bg=$onedark_green#,bold]} #h #{?window_zoomed_flag,#[fg=$onedark_yellow#,bg=$onedark_yellow],#[fg=$onedark_yellow#,bg=$onedark_green]}#[fg=$onedark_red,bg=$onedark_yellow]"
...
set "status-left" "#{?window_zoomed_flag,#[fg=$onedark_black#,bg=$onedark_yellow#,bold],#[fg=$onedark_black#,bg=$onedark_green#,bold]} #S #{prefix_highlight}#{?window_zoomed_flag,#[fg=$onedark_yellow#,bg=$onedark_black#,nobold#,nounderscore#,noitalics],#[fg=$onedark_green#,bg=$onedark_black#,nobold#,nounderscore#,noitalics]}"
